...
var _ = require('lodash'), async = require('async'), mailparser = require('./mailparser'), DRIVER = require('./filesdriver'), EXPIRY = 60, templatesDriver = DRIVER(), mails, shouldUseStyliner = false, Styliner = require('styliner');
